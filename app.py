...
DEFAULT_EVENTS = [
    ...
    {"name": "Otvorenie súťaže", "start": time(8, 30), "dur": 15, "color": "#D9D9D9",
     "groups": False, "num_groups": 1, "g_starts": [], "g_sizes": []},
    {"name": "Sprievodný program počas súťaže", "start": time(8, 45), "dur": 90, "color": "#D9D9D9",
     "groups": True, "num_groups": 4,
     "g_starts": [time(8, 45), time(10, 15), time(12, 15), time(13, 45)], "g_sizes": [0, 0, 0, 0]},
    ...
    {"name": "Ukončenie súťaže", "start": time(13, 45), "dur": 5, "color": "#D9D9D9",
     "groups": False, "num_groups": 1, "g_starts": [], "g_sizes": []},
    {"name": "Sprievodný program po skončení súťaže", "start": time(14, 0), "dur": 45, "color": "#D9D9D9",
     "groups": False, "num_groups": 1, "g_starts": [], "g_sizes": []},
...
def color_swatch_picker(current_hex, key_prefix):
    names = [n for _, n in COLOR_PALETTE]
    norm = current_hex.upper()
    lookup = {h.upper(): n for h, n in COLOR_PALETTE}
    current_name = lookup.get(norm)
