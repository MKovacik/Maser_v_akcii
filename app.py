...
DEFAULT_EVENTS = [
    ...
    {"name": "Otvorenie súťaže", "start": time(8, 30), "dur": 15, "color": "#D9D9D9",
     "groups": False, "num_groups": 1, "g_starts": [], "g_sizes": []},
    {"name": "Sprievodný program – Vojaci a Samaritáni", "start": time(8, 45), "dur": 30, "color": "#D9D9D9",
    ...
    {"name": "Ukončenie súťaže", "start": time(13, 45), "dur": 5, "color": "#D9D9D9",
     "groups": False, "num_groups": 1, "g_starts": [], "g_sizes": []},
    {"name": "Sprievodný program – NU det. TBC", "start": time(14, 0), "dur": 45, "color": "#B4C7E7",
     "groups": False, "num_groups": 1, "g_starts": [], "g_sizes": []},
...
if "schedule" in st.session_state:
    ...
    import subprocess
    is_local = os.environ.get("HOSTNAME", "") == "" and os.path.isdir(os.path.join(SCRIPT_DIR, ".git"))
    if is_local:
